...
CNAME="chk_c6_app_lamp"
INAME="qmul/centos6_app_lamp"
...
cp -f ${INC}/supervisord.s_h_m ./supervisord.conf


#~# Building with image name qmul/centos6_app_lamp:${VER}
echo -e "\n\n*** Building ${INAME} container image - version ${VER} ***\n\n"

#~# Tag image name qmul/centos6_app_lamp:latest
