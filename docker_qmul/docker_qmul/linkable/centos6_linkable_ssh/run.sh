...
#~# QMUL CentOS 6 Application SSH container
#
# 2015-12-08 I.Price@qmul.ca.uk : Original file
...
# 2015-12-08 I.Price@qmul.ca.uk : Added Resource limits & ulimits

if [[ -z $1 ]]
    then
        CNAME="chk_c6_lnk_ssh"
    else
        CNAME=${1}
fi
INAME="qmul/centos6_linkable_ssh"
...
#~# Create container from qmul/centos6_app_wordpress image with name chk_c6_app_wp
