...
#~# QMUL CentOS 6 Apache linkable image
#
# 2015-11-25 I.Price@qmul.ac.uk : v1.0 Created
# 2015-11-30 I.Price@qmul.ca.uk : Updated build tags and turned comments into Usage
# 2015-11-30 I.Price@qmul.ca.uk : Added standard function calls
# 2015-12-04 I.Price@qmul.ca.uk : Added Resource limits & ulimits

if [[ -z $1 ]]
    then
        CNAME="chk_c6_lnk_apache"
    else
        CNAME=${1}
fi
...
#~# Create container from qmul/centos6_base:v1.0 image with name chk_c6_link_apache
